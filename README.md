[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/vTLBoLmS)
# Code Generation
...
Feel free to add modifications to files from previous projects such as `uc_type.py` or `uc_ast.py` to complement your solution.

## Requirements

Use Python 3.10 or a newer version.    
Required pip packages:
- sly, pytest, setuptools, graphviz
...
Or, if you installed the project in your environment, you can use the `uc-code`
